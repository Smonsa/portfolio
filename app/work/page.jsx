...
const projects =[
  {
    ...
    title:"project 1",
    description:
     "Development, design and maintenance of the company's website. Direction and supervision of the academic content of the web platform",
     stack:[{name:"Html 5"},{name:"Css 3" }, {name: "Javascript"}],
     image:"/assets/work/iutcm.png",
     live:"https://www.iutcm.online/pages/home",
     github:"",
  },
  {
    num: "02",
    ...
    title:"project 2",
    description:
     "Development of a web platform to manage the scholarship system database linked to a MongoDB database and exported as a .xls",
     stack:[{name:"Next.js"},{name:"Tailwind.css" }, {name: "Node.js"}],
     image:"/assets/work/saberyemprenderblur.png",
     live:"saberyemprender.vercel.app",
     github:"https://github.com/itemprendetec/saberyemprender",
  },
  {
    num: "03",
    category:"frontend",
    title:"project 3",
    description:
     "Development, design and maintenance of the website using Thinkific as a LMS.",
     stack:[{name:"Html 5"},{name:"Css 3" }, {name: "Javascript"}, {name: "Thinkific"}],
     image:"/assets/work/dohmi.png",
