...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+58) 412 0707 815",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "simonsalve120@gmail.com",
  },
  {
    icon: <FaMapMarkedAlt />,
    title: "Address",
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                If you're ready to embark on a new project or explore how I can
                contribute to the success of your organization, please don't
                hesitate to reach out. I'm excited to discuss how we can work
